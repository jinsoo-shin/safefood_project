...
<body>
	...
	<div class="container-fluid" style="width: 80%">
		...
		<c:if test="${empty eatfoods}">
			<h3>상품 정보가 없습니다.</h3>
		</c:if>
		<div class="row" id="dataarea"></div>
		<div class="card-deck">
			<c:set var="count" value='0' />
			<c:forEach var="food" items="${eatfoods}">
				...
				<div class='col-lg-4 mb-4' id='foodinfo'>
					<div class='card h-100'>
						...
						<c:url var="deleteEat" value="/deleteEat"></c:url>
						<div class='card-footer'>
							<a class='btn btn-primary' href='${deleteEat}?code=${food.code}'>
								삭제 <span class='glyphicon glyphicon-chevron-right'></span>
							</a>
...
chart.data = [{
    "name": "칼로리",
    "value": ${eatnum.getCalory()}
}, {
    "name": "탄수화물",
    "value": ${eatnum.getCarbo()}
}, {
    "name": "단백질",
    "value": ${eatnum.getProtein()}
}, {
    "name": "지방",
    "value": ${eatnum.getFat()}
}, {
    "name": "당류",
    "value": ${eatnum.getSugar()}
}, {
    "name": "나트륨",
    "value": ${eatnum.getNatrium()/100}
}, {
    "name": "콜레스테롤",
    "value": ${eatnum.getChole()}
}, {
    "name": "포화지방산",
    "value": ${eatnum.getFattyacid()}
}, {
    "name": "트렌스지방",
    "value": ${eatnum.getTransfat()}
}
