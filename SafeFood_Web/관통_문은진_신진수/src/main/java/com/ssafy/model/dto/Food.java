...
public class Food {
	...
	public Food(double calory, double carbo, double protein, double fat, double sugar, double natrium, double chole,
	...
	public String toString() {
		return "알레르기 "+allergy+ "+Food [code=" + code + ", name=" + name + ", supportpereat=" + supportpereat + ", calory=" + calory
	...
	public Food(int code, String name, double supportpereat, double calory, double carbo, double protein, double fat,
			...
			String material, String img, List<String> allergy, Integer count) {
		super();
		this.code = code;
		this.name = name;
		this.supportpereat = supportpereat;
